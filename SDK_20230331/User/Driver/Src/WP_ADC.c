...
#define DIVIDER_RES_MAX  100000//分压电阻1
#define DIVIDER_RES_MIN  10000//分压电阻2
#define DIVIDER_RES_SCALE (DIVIDER_RES_MAX+DIVIDER_RES_MIN)/DIVIDER_RES_MIN
float DIVIDER_SCALE=1.045;
...
@入口参数：无
@出口参数：无
功能描述：测量电池电压，飞控默认分压比位11:1，故测量电压不要超过
3.3V*11=36.3V，若想测更大的电压，调整板子上分压电阻阻值即可
@作者：WUST
@日期：2019年01月27日
*************************************************************/
void Get_Battery_Voltage(void)//ADC获取   
{
	Battery_Voltage=(DIVIDER_SCALE*DIVIDER_RES_SCALE*curADCResult*3.3f)/16384;
	MAP_ADC14_toggleConversionTrigger();
}
/***********************************************************
@函数名：Get_Battery_Voltage
