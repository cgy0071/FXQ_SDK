...
void Bling_Init()
{
  MAP_GPIO_setAsOutputPin(GPIO_PORT_P5, GPIO_PIN6);//1.0
	MAP_GPIO_setAsOutputPin(GPIO_PORT_PJ, GPIO_PIN4);//2.0
	MAP_GPIO_setAsOutputPin(GPIO_PORT_PJ, GPIO_PIN5);//2.1
...
void Bling_Process(Bling_Light *Light)//闪烁运行线程
{
  ...
  else MAP_GPIO_setOutputHighOnPin(Light->Port,Light->Pin);//置高,灭
     ...
     ||Light->Endless_Flag==1)//判断无尽模式是否开启
  {
    ...
    if(5*Light->Bling_Cnt<=Light->Bling_Period*Light->Bling_Percent)
       MAP_GPIO_setOutputLowOnPin(Light->Port,Light->Pin);//置低，亮
    else MAP_GPIO_setOutputHighOnPin(Light->Port,Light->Pin);//置高，灭
  }
}
...
void Bling_Working(uint16 bling_mode)
{
  ...
  else if(bling_mode==3)//全灭
  {
		...
		MAP_GPIO_setOutputHighOnPin(GPIO_PORT_PJ,GPIO_PIN4);
		MAP_GPIO_setOutputHighOnPin(GPIO_PORT_PJ,GPIO_PIN5);
  }  
}
...
{
	Bling_Set(&Light_3,2000,800,0.5,0,GPIO_PORT_PJ,GPIO_PIN5,0);//红
  Bling_Set(&Light_1,2000,200,0.5,0,GPIO_PORT_P5,GPIO_PIN6,0);//绿
  Bling_Set(&Light_2,2000,500,0.5,0,GPIO_PORT_PJ,GPIO_PIN4,0);//蓝
}
/* Copyright (c)  2018-2025 Wuhan Nameless Innovation Technology Co.,Ltd. All rights reserved.*/
//	Bling_Set(&Light_3,2000,800,0.5,0,GPIO_PORT_P2,GPIO_PIN1,0);//红
//  Bling_Set(&Light_1,2000,200,0.5,0,GPIO_PORT_P1,GPIO_PIN6,0);//绿
//  Bling_Set(&Light_2,2000,500,0.5,0,GPIO_PORT_P2,GPIO_PIN0,0);//蓝
//  MAP_GPIO_setAsOutputPin(GPIO_PORT_P7, GPIO_PIN3);//1.0
//	MAP_GPIO_setAsOutputPin(GPIO_PORT_PJ, GPIO_PIN4);//2.0
//	MAP_GPIO_setAsOutputPin(GPIO_PORT_PJ, GPIO_PIN5);//2.1
