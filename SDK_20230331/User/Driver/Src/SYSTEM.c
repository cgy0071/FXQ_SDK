...
void HardWave_Init(void)
{
  ...
  Time_init();													//飞控调度定时器初始化
	...
	/*
	//俯仰角速度
	Total_Controller.Pitch_Gyro_Control.Kp=2.2;//1.90;//2.50;//俯仰角速度
	Total_Controller.Pitch_Gyro_Control.Ki=0.5;//0.80;//0.80;
	Total_Controller.Pitch_Gyro_Control.Kd=0.34;//0.38//0.44;//0.50;//0.48
	
	//翻滚角速度环
	Total_Controller.Roll_Gyro_Control.Kp=2.20;//2.60;//横滚角速度
	Total_Controller.Roll_Gyro_Control.Ki=0.5;//1.00;//1.00;
	Total_Controller.Roll_Gyro_Control.Kd=0.38;//0.42;//0.45//0.43
...
/*
	//高度加速度
	Total_Controller.High_Acce_Control.Kp = 0.29;//0.29;0.17//高度加速度
	Total_Controller.High_Acce_Control.Ki = 2.40;//2.20;
	...
	*/
	...
	Total_Controller.Optical_Position_Control.Kp=0.3;//0.18//光流位置
	...
	Total_Controller.Optical_Speed_Control.Kp = 5.9 ;//5.9;//6.90;//5.80//6.9
	Total_Controller.Optical_Speed_Control.Ki = 0.005;//0.01
	Total_Controller.Optical_Speed_Control.Kd = 1.0;//1.00
	...
	*/
	...
	//俯仰角速度
	Total_Controller.Pitch_Gyro_Control.Kp=2.10;//1.90//2.50;//俯仰角速度
	Total_Controller.Pitch_Gyro_Control.Ki=1.2;//0.80;//0.80;		//附近？
	Total_Controller.Pitch_Gyro_Control.Kd=0.46;//0.50;//0.48
	
	//翻滚角速度环
	Total_Controller.Roll_Gyro_Control.Kp=2.10;//2.60;//横滚角速度
	Total_Controller.Roll_Gyro_Control.Ki=1.0;//1.00;
	...
	*/
	...
	Total_Controller.Optical_Speed_Control.Kp =5.8 ;//6.90;//5.80//6.9
