...
#define NCQ_SDK_DUTY2 move_with_xy_target( 0, 150,&SDK_Duty_Status,2-1)
#define NCQ_SDK_DUTY3 find_black(200,&SDK_Duty_Status, 3-1)
#define NCQ_SDK_DUTY4 move_with_z_target(0,-5,0,&SDK_Duty_Status,4-1)
/*
...
void NCQ_SDK_Run(void)
{
  ...
  else if(SDK_Duty_Cnt==1)   {NCQ_SDK_DUTY2;	SDK_Ground_updata=1; Ground_OPENMV_mode=1;}
