...
Fhan_Data ADRC_Alt_Vel_Controller;
const float ADRC_Unit[4][16]=
{
  ...
  {1000000 ,0.0025 , 5,               300,      10000,      100000,      0.5,    0.85,   1.5,      0.0003,       2,    5,    0.9,   1.2,    0.03,    0.1},
  {1000000 ,0.0025 , 5,               300,      10000,      100000,      0.5,    0.85,   1.5,      0.0003,       2,    5,    0.9,   1.2,    0.03,    0.1},
	{100000  ,0.005  , 3,               300,      10000,      100000,      0.5,    0,      5,        0,            2,    5,    0.9,   1.2,    0.03,    0.1},
  {300000  ,0.0025 , 3,               300,      4000,      10000,     100,   0.2,    1.2,      0.0010,       5,      5,    0.8,   1.5,    0.03,    0.05},
};
...
void ADRC_Init(Fhan_Data *fhan_Input,uint16_t label)
{
  fhan_Input->r=ADRC_Unit[label][0];
  fhan_Input->h=ADRC_Unit[label][1];
  fhan_Input->N0=(uint16_t)(ADRC_Unit[label][2]);
  fhan_Input->beta_01=ADRC_Unit[label][3];
  fhan_Input->beta_02=ADRC_Unit[label][4];
  fhan_Input->beta_03=ADRC_Unit[label][5];
  fhan_Input->b0=ADRC_Unit[label][6];
  fhan_Input->beta_0=ADRC_Unit[label][7];
  fhan_Input->beta_1=ADRC_Unit[label][8];
  fhan_Input->beta_2=ADRC_Unit[label][9];
  fhan_Input->N1=(uint16_t)(ADRC_Unit[label][10]);
  fhan_Input->c=ADRC_Unit[label][11];
  
  fhan_Input->alpha1=ADRC_Unit[label][12];
  fhan_Input->alpha2=ADRC_Unit[label][13];
  fhan_Input->zeta=ADRC_Unit[label][14];
  fhan_Input->b=ADRC_Unit[label][15];
}
...
void ADRC_TD_Control(Fhan_Data *fhan_Input,float expect_ADRC,float feedback_ADRC)
{
  fhan_Input->TD_Input=expect_ADRC;
  fhan_Input->ESO_Input=feedback_ADRC; 
  /*自抗扰控制器第1步*/
  ...
  ********/
  ...
  fhan_Input->u0=5.0f*(fhan_Input->x1-fhan_Input->y);
  fhan_Input->u=Constrain_Float(fhan_Input->u0,-200,200);//不加入扰动补偿
}
